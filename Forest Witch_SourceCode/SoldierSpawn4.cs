...
public class SoldierSpawn4 : MonoBehaviour
{
    ...
    void Start()
    {
        points = GameObject.Find("SoldierSpawnPoint4").GetComponentsInChildren<Transform>();//SoldierSpawnPoint4を探し、下位にあるすべての<Transform>コンポーネントを探す。
