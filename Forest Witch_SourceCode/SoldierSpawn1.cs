...
public class SoldierSpawn1 : MonoBehaviour
{
    ...
    void Start()
    {
        points = GameObject.Find("SoldierSpawnPoint1").GetComponentsInChildren<Transform>();//SoldierSpawnPoint1を探し、下位にあるすべての<Transform>コンポーネントを探す。
